...
from courseinfo.views import (
    ...
    InstructorList, StudentList, CourseList, RegistrationList, SemesterList, SectionList, InstructorDetail,
    SectionDetail, StudentDetail, CourseDetail, RegistrationDetail, SemesterDetail, InstructorCreate, StudentCreate,
    CourseCreate, RegistrationCreate, SemesterCreate, SectionCreate, InstructorUpdate, StudentUpdate, CourseUpdate,
    RegistrationUpdate, SemesterUpdate, SectionUpdate, InstructorDelete, StudentDelete, CourseDelete,
    RegistrationDelete, SemesterDelete, SectionDelete)


class RegistrationrDelete(object):
    pass
