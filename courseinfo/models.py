...
class Semester(models.Model):
    ...
    year = models.ForeignKey(Year, related_name='semesters', on_delete=models.PROTECT) # PROTECT = no cascade delete
...
class Course(models.Model):
    ...
    def __str__(self):
        return '%s - %s' % (self.course_number, self.course_name)  # make django display course info
    ...
    class Meta:
        ordering = ['course_number','course_name']  # make courses appear in order
        unique_together = (('course_number','course_name'),) # make sure no duplicate course with both same # and name
